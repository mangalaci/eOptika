...
SELECT 	DISTINCT 
		...
		/*reminder_date*/
		CASE 	WHEN d.atvdat IS NOT NULL THEN DATE_ADD(d.atvdat,INTERVAL u1.wear_days + 12 DAY)
				ELSE  IF(t.courier_status_key = 13, DATE_ADD(t.courier_date,INTERVAL u1.wear_days + 12 DAY),IF(t.courier_status_key = 18,DATE_ADD(t.courier_date,INTERVAL u1.wear_days + 12 DAY),'9999-12-31'))
		END AS Detail11,
