...
ALTER TABLE SM_TAG_02 ADD INDEX `buyer_email` (`buyer_email`) USING BTREE;
ALTER TABLE SM_TAG_02 ADD INDEX `erp_invoice_id` (`erp_invoice_id`) USING BTREE;
ALTER TABLE SM_TAG_02 ADD INDEX `Entity` (`Entity`) USING BTREE;
ALTER TABLE SM_TAG_02 ADD INDEX `Type` (`Type`) USING BTREE;
ALTER TABLE SM_TAG_02 ADD INDEX `Tag` (`Tag`) USING BTREE;


INSERT INTO SM_TAG_02
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag1 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag2 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag3 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag4 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag5 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag6 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag7 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag8 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag9 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag10 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag11 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag12 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag13 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag14 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag15 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag16 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag17 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag18 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag19 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag20 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag21 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag22 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag23 AS Tag FROM SM_TAG_PURCHASE WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag1 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag2 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag3 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag4 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag5 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag6 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag7 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag8 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag9 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag10 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag11 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag12 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag13 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag14 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag15 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag16 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag17 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION 
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag18 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag19 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag20 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag21 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag22 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag23 AS Tag FROM SM_TAG_USER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag1 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag2 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag3 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag4 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag5 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag6 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag7 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag8 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag9 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag10 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag11 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag12 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag13 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag14 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag15 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag16 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag17 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag18 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
    UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag19 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
   UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag20 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
   UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag21 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
   UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag22 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
   UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag23 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
   UNION
SELECT buyer_email, erp_invoice_id, Entity, Type, Tag24 AS Tag FROM SM_TAG_OTHER WHERE Tag IS NOT NULL 
;



DROP TABLE IF EXISTS SM_TAG;
CREATE TABLE IF NOT EXISTS SM_TAG LIKE SM_TAG_02;
