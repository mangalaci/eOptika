...
SET
	...
	u.catchment_area = 	CASE 
							WHEN u.shipping_method = 'Pickup in person' OR i.region IN ('Budapest', 'Pest') THEN 'Budapest, Terez krt 41.' 
...
ALTER TABLE ORDERS_00 ADD INDEX (`personal_city`) USING BTREE;
