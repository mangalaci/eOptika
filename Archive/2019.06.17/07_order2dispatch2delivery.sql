...
ALTER TABLE BASE_03_TABLE_aux ADD PRIMARY KEY (erp_invoice_id);
...
SELECT item_id, erp_invoice_id, shipping_method, related_division, payment_method, shipping_country, CT1_SKU, CT1_SKU_name, CT2_pack, last_modified_date, connected_order_erp_id
FROM BASE_03_TABLE
...
ALTER TABLE TIME_ORDER_TO_DISPATCH_CARRIER_01 ADD PRIMARY KEY (item_id);
ALTER TABLE TIME_ORDER_TO_DISPATCH_CARRIER_01 ADD INDEX `erp_invoice_id` (`erp_invoice_id`) USING BTREE;
...
SELECT DISTINCT item_id, erp_invoice_id, shipping_method, related_division, payment_method, shipping_country, CT1_SKU, CT1_SKU_name, CT2_pack, last_modified_date, connected_order_erp_id
FROM BASE_03_TABLE
WHERE connected_order_erp_id <> ''
AND origin = 'invoices'
;
...
SELECT DISTINCT sz.item_id,
				sz.erp_invoice_id,
				r.erp_id AS erp_order_id,
				sz.shipping_method,
				sz.related_division,
...
ALTER TABLE TIME_ORDER_TO_DISPATCH_CARRIER_03 ADD INDEX (item_id);
ALTER TABLE TIME_ORDER_TO_DISPATCH_CARRIER_03 ADD INDEX `erp_invoice_id` (`erp_invoice_id`) USING BTREE;
ALTER TABLE TIME_ORDER_TO_DISPATCH_CARRIER_03 ADD INDEX `erp_order_id` (`erp_order_id`) USING BTREE;
...
GROUP BY item_id
ORDER BY erp_order_id
LIMIT 0
;

ALTER TABLE TIME_ORDER_TO_DISPATCH_PICKUP ADD PRIMARY KEY (item_id);
ALTER TABLE TIME_ORDER_TO_DISPATCH_PICKUP ADD INDEX `erp_invoice_id` (`erp_invoice_id`) USING BTREE;
ALTER TABLE TIME_ORDER_TO_DISPATCH_PICKUP ADD INDEX `erp_order_id` (`erp_order_id`) USING BTREE;
...
ALTER TABLE TIME_ORDER_TO_DISPATCH ADD INDEX `item_id` (`item_id`) USING BTREE;
ALTER TABLE TIME_ORDER_TO_DISPATCH ADD INDEX `erp_invoice_id` (`erp_invoice_id`) USING BTREE;
