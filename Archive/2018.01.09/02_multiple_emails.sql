...
SELECT DISTINCT real_name_clean, 
				billing_zip_code, 
...
ALTER TABLE USER_04_real_name_billing_zip_code_key ADD PRIMARY KEY (`real_name_clean`, `billing_zip_code`) USING BTREE;
ALTER TABLE USER_04_real_name_billing_zip_code_key ADD INDEX `user_id` (`user_id`);
ALTER TABLE BASE_00i_TABLE ADD INDEX (`real_name_clean`, `billing_zip_code`) USING BTREE;
...
ALTER TABLE USER_05_real_name_billing_zip_code_key ADD PRIMARY KEY (`related_email_clean`, `shipping_phone`, `real_name_clean`, `billing_zip_code`, `related_division`) USING BTREE;
...
HAVING (COUNT(DISTINCT related_email_clean) > 1 AND COUNT(DISTINCT real_name_clean) > 1)
;
...
ALTER TABLE USER_24_shipping_phone_real_name_clean_key ADD PRIMARY KEY (`shipping_phone`, `real_name_clean`) USING BTREE;
ALTER TABLE BASE_00i_TABLE ADD INDEX (`shipping_phone`, `real_name_clean`) USING BTREE;
...
FROM BASE_00i_TABLE AS a, USER_24_shipping_phone_real_name_clean_key AS b
WHERE a.shipping_phone = b.shipping_phone
...
CASE 
	...
	END AS user_id 
FROM USER_25_shipping_phone_real_name_clean_key a 
...
ALTER TABLE `USER_26_shipping_phone_real_name_clean_key` ADD INDEX `related_email_clean` (`related_email_clean`) USING BTREE;
