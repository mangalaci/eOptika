...
ALTER TABLE BASE_08_TABLE CHANGE `connected_order_erp_id` `connected_order_erp_id` FLOAT COMMENT 'Refers to "incoming_orders" table "erp_id" column.';
ALTER TABLE BASE_08_TABLE CHANGE `connected_delivery_note_erp_id` `connected_delivery_note_erp_id` FLOAT COMMENT 'Refers to "delivery_notes" table "erp_id" column.';
...
ALTER TABLE BASE_08_TABLE CHANGE `marketing_channel` `marketing_channel` VARCHAR(100) COMMENT 'Marketing csatorna: melyik marketing csatornan jott be a megrendeles';
