...
DROP TABLE BASE_00f_TABLE;
CREATE TABLE BASE_00f_TABLE AS
SELECT DISTINCT a.*, b.*,
				...
				c.box_height,
				c.box_depth
FROM BASE_00e_TABLE AS a LEFT JOIN ab_cikkto_full AS b
