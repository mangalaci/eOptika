...
SELECT  *,
    item_net_value_in_currency*exchange_rate_of_currency AS item_revenue_in_base_currency,
    item_vat_value_in_currency*exchange_rate_of_currency AS item_vat_in_base_currency,
    item_gross_value_in_currency*exchange_rate_of_currency AS item_gross_revenue_in_base_currency
FROM BASE_06_TABLE
;
