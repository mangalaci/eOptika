...
ALTER TABLE ORDERS_00d3 ADD INDEX `real_name` (`real_name`) USING BTREE;
...
ALTER TABLE ORDERS_00d4 ADD INDEX `real_name` (`real_name`) USING BTREE;
...
ALTER TABLE ORDERS_00d5 ADD INDEX `real_name` (`real_name`) USING BTREE;
