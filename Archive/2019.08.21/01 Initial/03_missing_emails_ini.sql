...
SELECT personal_name, billing_zip_code, related_division FROM `BASE_00i_TABLE`
LIMIT 0;
...
SELECT DISTINCT personal_name, billing_zip_code, related_division
FROM `BASE_00i_TABLE`
...
SELECT personal_name, billing_zip_code, buyer_email, related_division FROM `BASE_00i_TABLE`
LIMIT 0;
...
SELECT DISTINCT personal_name, billing_zip_code, buyer_email, related_division
FROM `BASE_00i_TABLE`
...
SELECT b.personal_name, b.billing_zip_code, e.buyer_email, b.related_division
...
SELECT b.personal_name, b.billing_zip_code, b.buyer_email, b.related_division, e.crm_id
...
SELECT DISTINCT personal_name, billing_zip_code, related_division, user_id
...
SELECT DISTINCT personal_name, billing_zip_code, related_division, (user_id*5) AS user_id
FROM USER_38_non_matching_emails;