...
SELECT DISTINCT shipping_name_clean, billing_zip_code
FROM `BASE_00h_TABLE`
...
/*shipping_name_clean és billing_zip_code pároshoz tartozó related_email_clean*/
DROP TABLE USER_04_name_zip_emails;
CREATE TABLE USER_04_name_zip_emails AS
SELECT DISTINCT shipping_name_clean, billing_zip_code, related_email_clean
FROM `BASE_00h_TABLE`
...
SELECT b.shipping_name_clean, b.billing_zip_code, e.related_email_clean
...
--ELÁGAZTATÁS
/*A: nincs email cím, de van másik sor u.a. névvel és irányító számmal*/
...
CREATE TABLE USER_07_matching_emails_plus_ID AS
SELECT b.shipping_name_clean, b.billing_zip_code, b.related_email_clean, e.user_id
...
/*B: nincs email cím és nincs másik sor u.a. névvel és irányító számmal*/
...
CREATE TABLE USER_09_non_matching_emails AS
SELECT DISTINCT shipping_name_clean, billing_zip_code, (user_id*3)-2 AS user_id
