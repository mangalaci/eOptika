...
ALTER TABLE BASE_09_TABLE ADD pickup_geogr_region VARCHAR(32) NOT NULL AFTER `typical_eye_drop`;
ALTER TABLE BASE_09_TABLE ADD real_geogr_region VARCHAR(32) NOT NULL AFTER `typical_eye_drop`;
