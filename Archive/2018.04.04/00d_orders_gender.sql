...
ALTER TABLE ORDERS_00d2 ADD INDEX `real_name_clean` (`real_name_clean`) USING BTREE;
ALTER TABLE ORDERS_00d2 ADD INDEX `shipping_country_standardized` (`shipping_country_standardized`) USING BTREE;
ALTER TABLE ORDERS_00d2 ADD INDEX `real_name` (`real_name`) USING BTREE;
...
ALTER TABLE ORDERS_00d3 ADD INDEX `real_name_clean` (`real_name_clean`) USING BTREE;
ALTER TABLE ORDERS_00d3 ADD INDEX `shipping_country_standardized` (`shipping_country_standardized`) USING BTREE;
ALTER TABLE ORDERS_00d3 ADD INDEX `related_webshop` (`related_webshop`) USING BTREE;
...
ALTER TABLE ORDERS_00d4 ADD INDEX `real_name_clean` (`real_name_clean`) USING BTREE;
...
ALTER TABLE ORDERS_00d5 ADD INDEX `real_name_clean` (`real_name_clean`) USING BTREE;
...
UPDATE ORDERS_00 AS m
        LEFT JOIN
    ORDERS_00d5 AS s ON m.sql_id = s.sql_id
SET
