...
UPDATE BASE_09_TABLE SET personal_name = CAP_FIRST(personal_name);
UPDATE BASE_09_TABLE SET pickup_name = CAP_FIRST(pickup_name);
UPDATE BASE_09_TABLE SET business_name = CAP_FIRST(business_name);
