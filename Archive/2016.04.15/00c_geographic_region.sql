...
DROP TABLE IF EXISTS BASE_00c1_TABLE;
...
ALTER TABLE BASE_00c1_TABLE ADD INDEX `billing_city_clean` (`billing_city_clean`) USING BTREE;


INSERT INTO BASE_00c1_TABLE
SELECT DISTINCT b.*, e.megye AS province, e.meret AS city_size
FROM BASE_00b_TABLE AS b LEFT JOIN IN_telepules_megye2 AS e
ON e.telepules_clean = b.billing_city_clean
;
...
DROP TABLE IF EXISTS BASE_00c2_TABLE;
...
DROP TABLE IF EXISTS BASE_00c3_TABLE;
