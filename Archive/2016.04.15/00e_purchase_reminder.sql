...
FROM BASE_00d_TABLE AS a, IN_vasarlas_emlekezteto AS b
...
DROP TABLE IF EXISTS BASE_00e_TABLE;
CREATE TABLE BASE_00e_TABLE
SELECT  a.*, b.reminder_day
FROM BASE_00d_TABLE AS a LEFT JOIN IN_vasarlas_emlekezteto2 AS b
