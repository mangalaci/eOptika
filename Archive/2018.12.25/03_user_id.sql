...
ALTER TABLE BASE_03_TABLE ADD `first_purchase` DATETIME COMMENT 'Date of first purchase of the user (ev, honap, nap)';
ALTER TABLE BASE_03_TABLE ADD `last_purchase` DATETIME COMMENT 'Date of last purchase of the user (ev, honap, nap)';
ALTER TABLE BASE_03_TABLE ADD `one_before_last_purchase` DATETIME COMMENT 'Date of one before last purchase of the user (ev, honap, nap)';
...
ALTER TABLE BASE_03_TABLE ADD `order_weekday` INT(1) COMMENT 'Weekday code of order received (0=Monday, Sunday=6, number)';
...
ALTER TABLE BASE_03_TABLE ADD `repeat_buyer` VARCHAR(20) COMMENT 'Visszatérő, vagy egyszeri vásárló';
...
ALTER TABLE BASE_03_TABLE ADD multi_user_account VARCHAR(20);
...
ALTER TABLE BASE_03_TABLE ADD user_active_flg VARCHAR(20);
ALTER TABLE BASE_03_TABLE ADD SKU_on_stock INT(2) COMMENT 'SKU is on stock. (0=no, 1=yes)';
...
ALTER TABLE BASE_03_TABLE ADD contact_lens_user INT(1);
ALTER TABLE BASE_03_TABLE ADD solution_user INT(1);
ALTER TABLE BASE_03_TABLE ADD eye_drops_user INT(1);
ALTER TABLE BASE_03_TABLE ADD sunglass_user INT(1);
ALTER TABLE BASE_03_TABLE ADD vitamin_user INT(1);
ALTER TABLE BASE_03_TABLE ADD frames_user INT(1);
ALTER TABLE BASE_03_TABLE ADD lenses_for_spectacles_user INT(1);
ALTER TABLE BASE_03_TABLE ADD spectacles_user INT(1);
ALTER TABLE BASE_03_TABLE ADD other_product_user INT(1);

ALTER TABLE BASE_03_TABLE ADD contact_lens_trials_user INT(1);
...
ALTER TABLE BASE_03_TABLE ADD date_lens_cleaners_run_out DATETIME COMMENT 'The date when placing a new order for a solutions user is due.';
...
ALTER TABLE BASE_03_TABLE ADD LVCR_item_flg INT(1) NOT NULL;
...
ALTER TABLE BASE_03_TABLE CHANGE `real_country` `personal_country` VARCHAR(50) COMMENT 'Country where user lives';
...
ALTER TABLE BASE_03_TABLE CHANGE `related_email_clean` `buyer_email` VARCHAR(100) COMMENT 'Megtisztitott email cim';
...
(b.billing_zip_code = e.billing_zip_code)
AND (b.real_name = e.real_name) 
;