...
ALTER TABLE `ORDERS_00a1` ADD `billing_name_trim` VARCHAR(255) NOT NULL;
...
AND item_group_name <> 'Szállítási díjak'
...
ALTER TABLE ORDERS_00a1 ADD INDEX `billing_name_trim` (`billing_name_trim`) USING BTREE;
