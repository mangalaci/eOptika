...
SELECT  sql_id,
    erp_id,
      ...
      item_net_purchase_price_in_base_currency
FROM  INVOICES_00f
WHERE item_sku IN ('KUPON', 'RABAT', '0', 'SZEPSZEMEK', 'RABAT_OTHER', 'RABAT_VAT')
) b
ON a.erp_id = b.erp_id
...
DELETE FROM INVOICES_00g WHERE item_sku IN ('KUPON', 'RABAT', '0', 'TEST', 'SZEPSZEMEK', 'RABAT_OTHER', 'RABAT_VAT', 'ajandek');
