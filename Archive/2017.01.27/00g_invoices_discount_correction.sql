...
CREATE TABLE IF NOT EXISTS INVOICES_00g LIKE INVOICES_00f;
ALTER TABLE INVOICES_00g ADD `rabat_sql_id` INT(1) NOT NULL;

INSERT INTO INVOICES_00g
SELECT x.*,
        y.rabat_sql_id
FROM INVOICES_00f AS x
 LEFT JOIN
(
SELECT
    DISTINCT b.*,
...
SELECT
    ...
    COALESCE((a.item_net_purchase_price_in_base_currency + b.rabat_item_net_purchase_price_in_base_currency*a.item_net_purchase_price_in_base_currency/c.sum_item_net_purchase_price_in_base_currency),0) AS item_net_purchase_price_in_base_currency
FROM
(
SELECT *
FROM INVOICES_00g
