...
ALTER TABLE BASE_03_TABLE ADD `primary_email` VARCHAR(255) NOT NULL;
ALTER TABLE BASE_03_TABLE ADD `secondary_email` VARCHAR(255) NOT NULL;
ALTER TABLE BASE_03_TABLE ADD `primary_newsletter_flg` VARCHAR(255) NOT NULL;
ALTER TABLE BASE_03_TABLE ADD `secondary_newsletter_flg` VARCHAR(255) NOT NULL;
...
DROP TABLE IF EXISTS BASE_03a_TABLE_aux;
CREATE TABLE IF NOT EXISTS BASE_03a_TABLE_aux
...
ALTER TABLE BASE_03a_TABLE_aux ADD `id` INT UNSIGNED NOT NULL AUTO_INCREMENT FIRST, ADD PRIMARY KEY (`id`);
ALTER TABLE BASE_03a_TABLE_aux ADD INDEX (`primary_email`) USING BTREE;
ALTER TABLE BASE_03a_TABLE_aux ADD INDEX (`secondary_email`) USING BTREE;
ALTER TABLE BASE_03a_TABLE_aux ADD INDEX (`user_id`) USING BTREE;
...
UPDATE
BASE_03_TABLE AS c
LEFT JOIN BASE_03a_TABLE_aux AS g 
...
DROP TABLE IF EXISTS `BASE_04c_TABLE_missing_gender`;
CREATE TABLE IF NOT EXISTS `BASE_04c_TABLE_missing_gender`
...
ALTER TABLE BASE_04c_TABLE_missing_gender ADD PRIMARY KEY (`related_email_clean`) USING BTREE;


/*first_name*/
DROP TABLE IF EXISTS `BASE_04c_TABLE_best_first_name`;
CREATE TABLE IF NOT EXISTS `BASE_04c_TABLE_best_first_name`
...
(
SELECT DISTINCT related_email_clean 
FROM BASE_04c_TABLE_missing_gender
)
...
ALTER TABLE BASE_04c_TABLE_best_first_name ADD PRIMARY KEY (`related_email_clean`) USING BTREE;
ALTER TABLE BASE_04c_TABLE_best_first_name CHANGE `first_name` `first_name` VARCHAR(100);
ALTER TABLE BASE_04c_TABLE_best_first_name ADD INDEX `first_name` (`first_name`) USING BTREE;



UPDATE
BASE_03_TABLE AS b
LEFT JOIN BASE_04c_TABLE_best_first_name AS n ON b.related_email_clean = n.related_email_clean
SET
...
/*full_name*/
DROP TABLE IF EXISTS `BASE_04c_TABLE_best_full_name`;
CREATE TABLE IF NOT EXISTS `BASE_04c_TABLE_best_full_name`
...
ALTER TABLE BASE_04c_TABLE_best_full_name ADD PRIMARY KEY (`related_email_clean`) USING BTREE;
ALTER TABLE BASE_04c_TABLE_best_full_name CHANGE `full_name` `full_name` VARCHAR(100);
ALTER TABLE BASE_04c_TABLE_best_full_name ADD INDEX `full_name` (`full_name`) USING BTREE;


UPDATE
BASE_03_TABLE AS b
LEFT JOIN BASE_04c_TABLE_best_full_name AS n ON b.related_email_clean = n.related_email_clean
SET
