...
CREATE TABLE IF NOT EXISTS SHIPPING_FEES_001 LIKE INVOICES_00c2;
...
CASE
	WHEN shipping_name_flg = 'real' THEN IF(shipping_address = '', billing_address, shipping_address) /* azért kell az IF, hogy ha üres a shipping_address */
	WHEN billing_name_flg = 'real' THEN IF(billing_address = '', shipping_address, billing_city) /* azért kell az IF, hogy ha üres a billing_address */
END AS real_address,
