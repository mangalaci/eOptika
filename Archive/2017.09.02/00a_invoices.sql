...
/*HIBAJAVÍTÓ */
UPDATE INVOICES_00a SET exchange_rate_of_currency = 359.31 WHERE erp_id = 'SE17/E000489';
UPDATE INVOICES_00a SET exchange_rate_of_currency = 1 WHERE erp_id = 'SP17/E000199';



/*
SELECT exchange_rate_of_currency, related_division, related_webshop, shipping_country
FROM outgoing_bills
WHERE erp_id = 'SP17/E000199'
;
*/
