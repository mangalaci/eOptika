...
ALTER TABLE CANCELLED_ORDERS_00c3 ADD INDEX `shipping_country_standardized` (`shipping_country_standardized`) USING BTREE;



/* S H I P P I N G   N A M E   M O D U L E:   B E G I N */
DROP TABLE IF EXISTS CANCELLED_ORDERS_00p0;
CREATE TABLE CANCELLED_ORDERS_00p0
SELECT 	DISTINCT
		shipping_name,
		shipping_name_trim,
...
FROM CANCELLED_ORDERS_00c3
;


ALTER TABLE CANCELLED_ORDERS_00p0 ADD `id` INT UNSIGNED NOT NULL AUTO_INCREMENT FIRST, ADD PRIMARY KEY (`id`);
ALTER TABLE CANCELLED_ORDERS_00p0 DROP COLUMN shipping_name_trim;


DROP TABLE IF EXISTS CANCELLED_ORDERS_00p1;
CREATE TABLE IF NOT EXISTS CANCELLED_ORDERS_00p1 LIKE CANCELLED_ORDERS_00p0;
ALTER TABLE `CANCELLED_ORDERS_00p1` ADD `pos_1` INT(4) NOT NULL;

INSERT INTO CANCELLED_ORDERS_00p1
SELECT 	DISTINCT
		id,
		shipping_name,
		shipping_country_standardized,
	...
	END AS	pos_1
FROM CANCELLED_ORDERS_00p0
;


DROP TABLE IF EXISTS CANCELLED_ORDERS_00p2;
CREATE TABLE IF NOT EXISTS CANCELLED_ORDERS_00p2 LIKE CANCELLED_ORDERS_00p1;
ALTER TABLE `CANCELLED_ORDERS_00p2` ADD `pos_2` INT(4) NOT NULL;

INSERT INTO CANCELLED_ORDERS_00p2
SELECT 	DISTINCT
		id,
		shipping_name,
		shipping_country_standardized,		
	...
	END AS	pos_2
FROM CANCELLED_ORDERS_00p1
;


DROP TABLE IF EXISTS CANCELLED_ORDERS_00p3;
CREATE TABLE IF NOT EXISTS CANCELLED_ORDERS_00p3 LIKE CANCELLED_ORDERS_00p2;
ALTER TABLE `CANCELLED_ORDERS_00p3` ADD `pos_3` INT(4) NOT NULL;

INSERT INTO CANCELLED_ORDERS_00p3
SELECT 	DISTINCT
		id,
		shipping_name,
		shipping_country_standardized,
	...
	END AS	pos_3
FROM CANCELLED_ORDERS_00p2
;


DROP TABLE IF EXISTS CANCELLED_ORDERS_00p4;
CREATE TABLE IF NOT EXISTS CANCELLED_ORDERS_00p4 LIKE CANCELLED_ORDERS_00p3;
ALTER TABLE `CANCELLED_ORDERS_00p4` ADD `pos_4` INT(4) NOT NULL;

INSERT INTO CANCELLED_ORDERS_00p4
SELECT 	DISTINCT
		id,
		shipping_name,
		shipping_country_standardized,		
	...
	END AS	pos_4
FROM CANCELLED_ORDERS_00p3
;


DROP TABLE IF EXISTS CANCELLED_ORDERS_00p5;
CREATE TABLE IF NOT EXISTS CANCELLED_ORDERS_00p5 LIKE CANCELLED_ORDERS_00p4;
ALTER TABLE `CANCELLED_ORDERS_00p5` ADD `pos_5` INT(4) NOT NULL;

INSERT INTO CANCELLED_ORDERS_00p5
SELECT 	DISTINCT
		id,
		shipping_name,
		shipping_country_standardized,		
	...
	END AS	pos_5
FROM CANCELLED_ORDERS_00p4
;


DROP TABLE IF EXISTS CANCELLED_ORDERS_00p6;
CREATE TABLE IF NOT EXISTS CANCELLED_ORDERS_00p6 LIKE CANCELLED_ORDERS_00p5;
ALTER TABLE `CANCELLED_ORDERS_00p6` ADD `pos_6` INT(4) NOT NULL;

INSERT INTO CANCELLED_ORDERS_00p6
SELECT 	DISTINCT
		id,
		shipping_name,
		shipping_country_standardized,		
	...
	END AS	pos_6
FROM CANCELLED_ORDERS_00p5
;


DROP TABLE IF EXISTS CANCELLED_ORDERS_00p7;
CREATE TABLE IF NOT EXISTS CANCELLED_ORDERS_00p7 LIKE CANCELLED_ORDERS_00p6;
ALTER TABLE `CANCELLED_ORDERS_00p7` ADD `pos_7` INT(4) NOT NULL;

INSERT INTO CANCELLED_ORDERS_00p7
SELECT 	DISTINCT
		id,
		shipping_name,
		shipping_country_standardized,		
	...
	END AS	pos_7
FROM CANCELLED_ORDERS_00p6
;


DROP TABLE IF EXISTS CANCELLED_ORDERS_00p8;
CREATE TABLE IF NOT EXISTS CANCELLED_ORDERS_00p8 LIKE CANCELLED_ORDERS_00p7;
ALTER TABLE `CANCELLED_ORDERS_00p8` ADD `parse_name_1` VARCHAR(255) NOT NULL;
ALTER TABLE `CANCELLED_ORDERS_00p8` ADD `parse_name_2` VARCHAR(255) NOT NULL;
ALTER TABLE `CANCELLED_ORDERS_00p8` ADD `parse_name_3` VARCHAR(255) NOT NULL;
ALTER TABLE `CANCELLED_ORDERS_00p8` ADD `parse_name_4` VARCHAR(255) NOT NULL;
ALTER TABLE `CANCELLED_ORDERS_00p8` ADD `parse_name_5` VARCHAR(255) NOT NULL;
ALTER TABLE `CANCELLED_ORDERS_00p8` ADD `parse_name_6` VARCHAR(255) NOT NULL;


INSERT INTO CANCELLED_ORDERS_00p8
SELECT 	DISTINCT
		id,
		shipping_name,
		shipping_country_standardized,		
...
FROM CANCELLED_ORDERS_00p7
;


ALTER TABLE CANCELLED_ORDERS_00p8
...
ALTER TABLE CANCELLED_ORDERS_00p8 ADD INDEX `shipping_name` (`shipping_name`) USING BTREE;
ALTER TABLE CANCELLED_ORDERS_00p8 ADD INDEX `shipping_country_standardized` (`shipping_country_standardized`) USING BTREE;
ALTER TABLE CANCELLED_ORDERS_00p8 ADD INDEX `parse_name_1` (`parse_name_1`) USING BTREE;
ALTER TABLE CANCELLED_ORDERS_00p8 ADD INDEX `parse_name_2` (`parse_name_2`) USING BTREE;
ALTER TABLE CANCELLED_ORDERS_00p8 ADD INDEX `parse_name_3` (`parse_name_3`) USING BTREE;
ALTER TABLE CANCELLED_ORDERS_00p8 ADD INDEX `parse_name_4` (`parse_name_4`) USING BTREE;
ALTER TABLE CANCELLED_ORDERS_00p8 ADD INDEX `parse_name_5` (`parse_name_5`) USING BTREE;
ALTER TABLE CANCELLED_ORDERS_00p8 ADD INDEX `parse_name_6` (`parse_name_6`) USING BTREE;
...
DROP TABLE IF EXISTS CANCELLED_ORDERS_00c4;
CREATE TABLE CANCELLED_ORDERS_00c4
SELECT 	DISTINCT 
		c.*,
		CASE 
...
ALTER TABLE CANCELLED_ORDERS_00c4 CHANGE `shipping_name_clean` `shipping_name_clean` VARCHAR(64);
ALTER TABLE CANCELLED_ORDERS_00c4 ADD INDEX `shipping_country_standardized` (`shipping_country_standardized`) USING BTREE;
ALTER TABLE CANCELLED_ORDERS_00c4 ADD INDEX `shipping_name` (`shipping_name`) USING BTREE;
ALTER TABLE CANCELLED_ORDERS_00c4 ADD INDEX `shipping_name_clean` (`shipping_name_clean`) USING BTREE;



INSERT INTO CANCELLED_ORDERS_00c4
SELECT 	DISTINCT 
		c.*,
		CASE 
			WHEN g1.first_name IS NOT NULL THEN c.parse_name_1
...
ALTER TABLE CANCELLED_ORDERS_00c3 ADD INDEX `shipping_name` (`shipping_name`) USING BTREE;
ALTER TABLE CANCELLED_ORDERS_00c3 DROP COLUMN shipping_name_trim;

DROP TABLE IF EXISTS CANCELLED_ORDERS_00c5;
CREATE TABLE IF NOT EXISTS CANCELLED_ORDERS_00c5 LIKE CANCELLED_ORDERS_00c3;
ALTER TABLE CANCELLED_ORDERS_00c5 ADD `shipping_name_clean`  VARCHAR(64);
ALTER TABLE CANCELLED_ORDERS_00c5 ADD INDEX `shipping_name_clean` (`shipping_name_clean`) USING BTREE;

INSERT INTO CANCELLED_ORDERS_00c5
SELECT DISTINCT c.*, d.shipping_name_clean 
FROM CANCELLED_ORDERS_00c3 c
LEFT JOIN CANCELLED_ORDERS_00c4 d
