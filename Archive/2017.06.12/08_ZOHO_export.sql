...
SET b.lens_multi_user = (SELECT m.lens_multi_user FROM multiple_lens_user as m WHERE b.user_id = m.user_id)
;
...
UPDATE BASE_08_TABLE as b
SET 
b.covered_days_over_dt = (SELECT m.covered_days_over_dt FROM BASE_08b_TABLE as m WHERE b.item_id = m.item_id)
WHERE b.origin = 'invoices'
;
