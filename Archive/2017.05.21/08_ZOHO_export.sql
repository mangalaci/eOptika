...
SELECT z.user_id, IFNULL(z.num_of_pwr_per_trx_over_limit,0) + z.pwr_diff_over_limit AS lens_multi_user
FROM
(
SELECT v.user_id,
...
ALTER TABLE BASE_07_TABLE ADD pwr_eye1 DECIMAL(6,2);
ALTER TABLE BASE_07_TABLE ADD pwr_eye2 DECIMAL(6,2);
...
UPDATE
BASE_07_TABLE AS b
LEFT JOIN user_eye_pwr AS m
ON (b.user_id = m.user_id)
SET
b.pwr_eye1 = m.pwr_eye1,
b.pwr_eye2 = m.pwr_eye2
;
