...
SELECT real_name, billing_zip_code, related_email_clean, related_division
FROM `BASE_00i_TABLE`
...
SELECT b.real_name, b.billing_zip_code, b.related_email_clean, b.related_division, e.user_id
...
SELECT DISTINCT real_name, billing_zip_code, related_division, (((SELECT MAX(user_id) FROM BASE_03_TABLE)+user_id)*5) AS user_id /* a belső SELECT azért kell, mert csak a már létező user_id-knál nagyobb id-t oszthatunk ki*/
