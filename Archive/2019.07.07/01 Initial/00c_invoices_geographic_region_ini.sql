...
SET    m.shipping_country_standardized = e.Country
...
SELECT * 
FROM INVOICES_00
WHERE item_group_name IN ('Szállítási díjak', 'Pénzbeszedési díjak', 'Pénzkezelési díjak')
;
...
ALTER TABLE INVOICES_00 ADD INDEX (`real_city`) USING BTREE;
