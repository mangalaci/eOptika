...
SELECT DISTINCT
    ...
    CASE 	WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id IN (17, 101, 183, 185, 202, 223, 252, 329, 336, 354, 370, 371, 248, 220)) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '_', '')) > 1 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '_', 2), ' ', -1)
			WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id IN (17, 101, 183, 185, 202, 223, 252, 329, 336, 354, 370, 371, 248, 220)) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '_', '')) = 1 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '_', 1), ' ', -1)
			WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id IN (17, 101, 183, 185, 202, 223, 252, 329, 336, 354, 370, 371, 248, 220)) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '+', '')) > 1 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '+', 2), ' ', -1)
			WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id IN (17, 101, 183, 185, 202, 223, 252, 329, 336, 354, 370, 371, 248, 220)) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '+', '')) = 1 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '+', 1), ' ', -1)
			WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id IN (17, 101, 183, 185, 202, 223, 252, 329, 336, 354, 370, 371, 248, 220)) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '-', '')) > 0 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '-', 1), ' ', -1)
			WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id IN (17, 101, 183, 185, 202, 223, 252, 329, 336, 354, 370, 371, 248, 220)) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '|', '')) > 0 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '|', 1), ' ', -1)
			WHEN (j.parent_id IN (8) OR i.group_id = 220) THEN i.sku
			WHEN (j.parent_id IN (2, 3) AND j.sku_eoptika_hu IS NULL) THEN i.sku
			ELSE CASE WHEN j.parent_id = 0 THEN i.name_hu ELSE j.sku_eoptika_hu END
    END AS CT2_sku,
		
    CASE 	WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id = 220) THEN i.sku
			WHEN j.general_name IS NOT NULL THEN j.general_name
			ELSE 'Unidentified'
	END AS CT2_pack,
	
    CASE 	WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id = 220) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '_', '')) > 1 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '_', 2), ' ', -1)
			WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id = 220) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '_', '')) = 1 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '_', 1), ' ', -1)
			WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id = 220) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '+', '')) > 1 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '+', 2), ' ', -1)
			WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id = 220) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '+', '')) = 1 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '+', 1), ' ', -1)
			WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id = 220) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '-', '')) > 0 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '-', 1), ' ', -1)			
			WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id = 220) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '|', '')) > 0 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '|', 1), ' ', -1)
    ...
    CASE 	WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id IN (17, 101, 183, 185, 202, 223, 252, 329, 336, 354, 370, 371, 248, 220)) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '_', '')) > 1 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '_', 2), ' ', -1)
			...
			WHEN (j.parent_id IN (81, 124, 332, 357, 367) OR i.group_id IN (17, 101, 183, 185, 202, 223, 252, 329, 336, 354, 370, 371, 248, 220)) AND LENGTH(i.sku) - LENGTH(REPLACE(i.sku, '|', '')) > 0 THEN SUBSTRING_INDEX(SUBSTRING_INDEX(i.sku, '|', 1), ' ', -1)
			WHEN (j.parent_id IN (8) OR i.group_id = 220) THEN i.name_hu
			WHEN (j.parent_id IN (2, 3) AND j.sku_eoptika_hu IS NULL) THEN i.name_hu			
			ELSE CASE WHEN j.parent_id = 0 THEN i.name_hu ELSE j.CT4_product_brand END
	...
	i.net_weight_in_kg,
					...
					CASE WHEN j.parent_id IN (4,5,6,7,77,101,124) AND LOCATE('PWR: ',i.name_hu) > 0 THEN SUBSTR(i.name_hu, LOCATE('PWR: ',i.name_hu)+5, 5)
						WHEN j.general_name LIKE '%Szemüveglencsék%' THEN 
					...
					CASE WHEN (j.parent_id IN (4,5,6,7,77,101,124) OR j.general_name LIKE '%Szemüveglencsék%') AND LOCATE('AX: ',i.name_hu) > 0 THEN SUBSTR(i.name_hu, LOCATE('AX: ',i.name_hu)+4, 4)
						 ELSE NULL
					END AS lens_ax,
					...
					CASE WHEN (j.parent_id IN (4,5,6,7,77,101,124) OR j.general_name LIKE '%Szemüveglencsék%') AND LOCATE('ADD: ',i.name_hu) > 0 THEN SUBSTR(i.name_hu, LOCATE('ADD: ',i.name_hu)+5, 5)
                         ELSE NULL
					END AS lens_add,
