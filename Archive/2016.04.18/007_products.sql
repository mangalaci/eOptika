...
DROP TABLE IF EXISTS BASE_007_TABLE;
CREATE TABLE IF NOT EXISTS BASE_007_TABLE
SELECT DISTINCT a.*, b.*,
...
/*A 007 tábla lemásolása*/
DROP TABLE IF EXISTS BASE_0072_TABLE;
CREATE TABLE BASE_0072_TABLE
SELECT * FROM BASE_007_TABLE
;


ALTER TABLE BASE_007_TABLE ADD PRIMARY KEY (`sql_id`) USING BTREE;
ALTER TABLE BASE_007_TABLE ADD INDEX `related_email_clean` (`related_email_clean`) USING BTREE;
ALTER TABLE BASE_007_TABLE ADD INDEX `shipping_name_clean` (`shipping_name_clean`) USING BTREE;
ALTER TABLE BASE_007_TABLE ADD INDEX `billing_zip_code` (`billing_zip_code`) USING BTREE;
ALTER TABLE BASE_007_TABLE ADD INDEX `erp_id` (`erp_id`) USING BTREE;
ALTER TABLE BASE_007_TABLE ADD INDEX `reference_id` (`reference_id`) USING BTREE;


ALTER TABLE BASE_0072_TABLE ADD PRIMARY KEY (`sql_id`) USING BTREE;
ALTER TABLE BASE_0072_TABLE ADD INDEX `related_email_clean` (`related_email_clean`) USING BTREE;
ALTER TABLE BASE_0072_TABLE ADD INDEX `shipping_name_clean` (`shipping_name_clean`) USING BTREE;
ALTER TABLE BASE_0072_TABLE ADD INDEX `billing_zip_code` (`billing_zip_code`) USING BTREE;
ALTER TABLE BASE_0072_TABLE ADD INDEX `erp_id` (`erp_id`) USING BTREE;
ALTER TABLE BASE_0072_TABLE ADD INDEX `reference_id` (`reference_id`) USING BTREE;
