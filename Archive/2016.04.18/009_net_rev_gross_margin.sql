DROP TABLE IF EXISTS BASE_009_TABLE;
CREATE TABLE BASE_009_TABLE
SELECT 	f2.*, 
...
FROM BASE_008_TABLE AS g, BASE_0072_TABLE AS f2
WHERE g.sql_id = f2.sql_id
;

ALTER TABLE BASE_009_TABLE
...
ALTER TABLE BASE_009_TABLE MODIFY COLUMN item_type VARCHAR(255) AFTER wear_duration;


ALTER TABLE BASE_009_TABLE ADD PRIMARY KEY (`sql_id`) USING BTREE;
ALTER TABLE BASE_009_TABLE ADD INDEX `erp_id` (`erp_id`) USING BTREE;
ALTER TABLE BASE_009_TABLE ADD INDEX `related_email_clean` (`related_email_clean`) USING BTREE;
ALTER TABLE BASE_009_TABLE ADD INDEX `shipping_name_clean` (`shipping_name_clean`) USING BTREE;
ALTER TABLE BASE_009_TABLE ADD INDEX `billing_zip_code` (`billing_zip_code`) USING BTREE;
ALTER TABLE BASE_009_TABLE ADD INDEX `reference_id` (`reference_id`) USING BTREE;
