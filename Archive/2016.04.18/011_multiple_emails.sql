...
FROM BASE_009_TABLE AS a, USER_04_shipping_name_billing_zip_code_key AS b
...
FROM BASE_009_TABLE AS a, USER_14_shipping_phone_billing_zip_code_key AS b
...
FROM BASE_009_TABLE AS a, USER_24_shipping_phone_shipping_name_clean_key AS b
WHERE a.shipping_phone = b.shipping_phone
