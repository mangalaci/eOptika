DROP TABLE IF EXISTS BASE_002_TABLE;
CREATE TABLE BASE_002_TABLE
SELECT
		 *,
...
ALTER TABLE BASE_002_TABLE CHANGE `related_email_clean` `related_email_clean` VARCHAR(255);  
  
  
  
ALTER TABLE BASE_002_TABLE ADD PRIMARY KEY (`sql_id`) USING BTREE;
ALTER TABLE BASE_002_TABLE ADD INDEX `related_email_clean` (`related_email_clean`) USING BTREE;
ALTER TABLE BASE_002_TABLE ADD INDEX `shipping_name_trim` (`shipping_name_trim`) USING BTREE;
ALTER TABLE BASE_002_TABLE ADD INDEX `billing_zip_code` (`billing_zip_code`) USING BTREE;