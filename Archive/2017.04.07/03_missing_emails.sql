...
SELECT real_name_clean, billing_zip_code, related_division FROM `BASE_00j_TABLE`
LIMIT 0;
...
SELECT real_name_clean, billing_zip_code, related_email_clean, related_division FROM `BASE_00j_TABLE`
LIMIT 0;
