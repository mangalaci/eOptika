...
SELECT 
	...
	t191.typical_lens_eye1_CT1_sku,
	t20.typical_lens_eye2_CT1,
	t201.typical_lens_eye2_CT1_sku,
...
LEFT JOIN typical_lens_eye1_CT1_sku t191
ON t1.user_id = t191.user_id
LEFT JOIN typical_lens_eye2_CT1 t20
ON t1.user_id = t20.user_id
LEFT JOIN typical_lens_eye2_CT1_sku t201
ON t1.user_id = t201.user_id
...
WHERE r.typical_wear_days_eye1 is not null
;
...
WHERE r.typical_wear_days_eye2 is not null
;
...
WHERE r.typical_wear_duration_eye1 is not null
;
...
WHERE r.typical_wear_duration_eye2 is not null
;
...
WHERE r.typical_lens_type_eye1 is not null
;
...
WHERE r.typical_lens_type_eye2 is not null
;
...
WHERE r.typical_lens_eye1_CT1 is not null
;
...
INNER JOIN typical_features r
ON r.user_id = u.user_id
SET u.typical_lens_eye1_CT1_sku = r.typical_lens_eye1_CT1_sku
WHERE r.typical_lens_eye1_CT1_sku is not null	
;
...
WHERE r.typical_lens_eye2_CT1 is not null
;
...
INNER JOIN typical_features r
ON r.user_id = u.user_id
SET u.typical_lens_eye2_CT1_sku = r.typical_lens_eye2_CT1_sku
WHERE r.typical_lens_eye2_CT1_sku is not null
;
...
WHERE r.typical_lens_eye1_CT2 is not null
;
...
WHERE r.typical_lens_eye2_CT2 is not null
;
...
WHERE r.typical_solution_CT2 is not null
;
...
WHERE r.typical_eye_drop_CT2 is not null
;
...
WHERE r.typical_lens_eye1_CT3 is not null
;
...
WHERE r.typical_lens_eye2_CT3 is not null
;
...
WHERE r.typical_solution_CT3 is not null
;
...
WHERE r.typical_eye_drop_CT3 is not null
;
...
WHERE r.typical_lens_eye1_CT4 is not null
;
...
WHERE r.typical_lens_eye2_CT4 is not null
;
...
WHERE r.typical_solution_CT4 is not null
;
...
WHERE r.typical_eye_drop_CT4 is not null
;
...
WHERE r.typical_lens_eye1_CT5 is not null
;
...
WHERE r.typical_lens_eye2_CT5 is not null
;
...
WHERE r.typical_solution_CT5 is not null
;
...
WHERE r.typical_eye_drop_CT5 is not null
;
...
WHERE r.typical_lens_pack_size is not null
;
...
WHERE r.typical_solution_pack_size is not null
;
...
WHERE r.typical_eye_drop_pack_size is not null
;
...
ALTER TABLE BASE_10_TABLE DROP COLUMN GDPR_status;
