...
ALTER TABLE INVOICES_00 ADD INDEX (`CT2_pack`) USING BTREE;

UPDATE
  INVOICES_00 AS C
  INNER JOIN (
SELECT CT2_pack, MIN(created) AS product_introduction_dt FROM INVOICES_002 GROUP by CT2_pack
