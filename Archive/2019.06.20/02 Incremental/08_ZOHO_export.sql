...
DROP TABLE IF EXISTS BASE_09_TABLE_teszt;
CREATE TABLE IF NOT EXISTS BASE_09_TABLE_teszt LIKE BASE_03_TABLE;
ALTER TABLE BASE_09_TABLE_teszt ADD pickup_geogr_region VARCHAR(32) NOT NULL;
ALTER TABLE BASE_09_TABLE_teszt ADD personal_geogr_region VARCHAR(32) NOT NULL;
ALTER TABLE BASE_09_TABLE_teszt ADD LVCR_item_flg INT(1) NOT NULL;


INSERT INTO BASE_09_TABLE_teszt
SELECT 	 u.*
...
ALTER TABLE BASE_09_TABLE_teszt
