...
ALTER table AGGR_ORDER add INDEX (`reference_id`) USING BTREE;
ALTER table AGGR_ORDER add INDEX (`related_division`) USING BTREE;
ALTER table AGGR_ORDER add INDEX (`related_webshop`) USING BTREE;
ALTER table AGGR_ORDER add INDEX (`invoice_yearmonth`) USING BTREE;
