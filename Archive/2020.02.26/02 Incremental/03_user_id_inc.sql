...
ALTER TABLE BASE_00i_TABLE ADD `cohort_id` char(7) COMMENT 'Cohort ID (ev, honap)';
ALTER TABLE BASE_00i_TABLE ADD `first_purchase` TIMESTAMP NULL DEFAULT NULL COMMENT 'Date of first purchase of the user (ev, honap, nap)';
ALTER TABLE BASE_00i_TABLE ADD `last_purchase` TIMESTAMP NULL DEFAULT NULL COMMENT 'Date of last purchase of the user (ev, honap, nap)';
ALTER TABLE BASE_00i_TABLE ADD `one_before_last_purchase` TIMESTAMP NULL DEFAULT NULL  COMMENT 'Date of one before last purchase of the user (ev, honap, nap)';
ALTER TABLE BASE_00i_TABLE ADD `contact_lens_last_purchase` TIMESTAMP NULL DEFAULT NULL  COMMENT 'Date of last contact lens purchase of the user (ev, honap, nap)';
ALTER TABLE BASE_00i_TABLE ADD `invoice_yearmonth` char(7) COMMENT 'Year and month of invoicing (text)';
ALTER TABLE BASE_00i_TABLE ADD `invoice_year` smallint(1) COMMENT 'Year of invoicing (number)';
ALTER TABLE BASE_00i_TABLE ADD `invoice_month` smallint(1) COMMENT 'Month of invoicing (1 to 12, number)';
ALTER TABLE BASE_00i_TABLE ADD `invoice_quarter` tinyint(1) COMMENT 'Quarter of invoicing (1 to 4, number)';
ALTER TABLE BASE_00i_TABLE ADD `invoice_day_in_month` tinyint(1) COMMENT 'Calendar day of invoicing (1 to 31, number)';
ALTER TABLE BASE_00i_TABLE ADD `invoice_hour` tinyint(1) COMMENT 'Hour of invoicing (0 to 23, number, rounded down)';
ALTER TABLE BASE_00i_TABLE ADD `order_year` smallint(1) COMMENT 'Year of order received (number)';
ALTER TABLE BASE_00i_TABLE ADD `order_month` tinyint(2) COMMENT 'Month of order received (1 to 12, number)';
ALTER TABLE BASE_00i_TABLE ADD `order_quarter` tinyint(1) COMMENT 'Quarter of order received (1 to 4, number)';
ALTER TABLE BASE_00i_TABLE ADD `order_day_in_month` tinyint(2) COMMENT 'Calendar day of order received (1 to 31, number)';
ALTER TABLE BASE_00i_TABLE ADD `order_hour` tinyint(2) COMMENT 'Hour of order received ( 1 to 24, number, rounded down)';
ALTER TABLE BASE_00i_TABLE ADD `order_weekday` tinyint(1) COMMENT 'Weekday code of order received (0=Monday, Sunday=6, number)';
ALTER TABLE BASE_00i_TABLE ADD `order_week_in_month` tinyint(1) COMMENT 'Monthly week code of order received (1 to 5, number)';
ALTER TABLE BASE_00i_TABLE ADD `cohort_month_since` smallint(1) COMMENT 'Hanyadik honapban tortent a tranzakcio a user elso vasarlasa ota (amikor bekerult a cohortba). Csak számláknál értelmezhető!';
...
ALTER TABLE BASE_00i_TABLE ADD `repeat_buyer` char(15) COMMENT 'Visszatérő, vagy egyszeri vásárló';
...
ALTER TABLE BASE_00i_TABLE ADD `primary_newsletter_flg` char(20);
ALTER TABLE BASE_00i_TABLE ADD `secondary_newsletter_flg` char(20);
...
ALTER TABLE BASE_00i_TABLE ADD `trx_marketing_channel` char(20) NOT NULL;
...
ALTER TABLE BASE_00i_TABLE ADD multi_user_account ENUM('single user', 'multi user', 'no lens yet');
...
ALTER TABLE BASE_00i_TABLE ADD user_active_flg ENUM('active', 'inactive');
ALTER TABLE BASE_00i_TABLE ADD SKU_on_stock tinyint(1) COMMENT 'SKU is on stock. (0=no, 1=yes)';
...
ALTER TABLE BASE_00i_TABLE ADD contact_lens_user tinyint(1);
ALTER TABLE BASE_00i_TABLE ADD solution_user tinyint(1);
ALTER TABLE BASE_00i_TABLE ADD eye_drops_user tinyint(1);
ALTER TABLE BASE_00i_TABLE ADD sunglass_user tinyint(1);
ALTER TABLE BASE_00i_TABLE ADD vitamin_user tinyint(1);
ALTER TABLE BASE_00i_TABLE ADD frames_user tinyint(1);
ALTER TABLE BASE_00i_TABLE ADD lenses_for_spectacles_user tinyint(1);
ALTER TABLE BASE_00i_TABLE ADD spectacles_user tinyint(1);
ALTER TABLE BASE_00i_TABLE ADD other_product_user tinyint(1);
ALTER TABLE BASE_00i_TABLE ADD contact_lens_trials_user tinyint(1);

ALTER TABLE BASE_00i_TABLE ADD date_lenses_run_out TIMESTAMP NULL DEFAULT NULL  COMMENT 'The date when placing a new order for a contact lens user is due.';
ALTER TABLE BASE_00i_TABLE ADD date_lens_cleaners_run_out TIMESTAMP NULL DEFAULT NULL  COMMENT 'The date when placing a new order for a solutions user is due.';
...
ALTER TABLE BASE_00i_TABLE ADD marketing_cost_in_base_currency float AFTER packaging_cost_in_base_currency;
ALTER TABLE BASE_00i_TABLE ADD overhead_cost_in_base_currency float AFTER marketing_cost_in_base_currency;
ALTER TABLE BASE_00i_TABLE ADD LVCR_item_flg tinyint(1) NOT NULL;
...
ALTER TABLE BASE_00i_TABLE ADD supplier_name VARCHAR(100) DEFAULT NULL;

ALTER TABLE BASE_00i_TABLE CHANGE `sql_id` `item_id` INT(10);
ALTER TABLE BASE_00i_TABLE CHANGE `erp_id` `erp_invoice_id` char(13);
ALTER TABLE BASE_00i_TABLE CHANGE `origin` `origin` char(9) COMMENT 'Invoices = paid invoices; Orders = cancelled order. Invoices+Orders = all orders';
ALTER TABLE BASE_00i_TABLE CHANGE `created` `created` TIMESTAMP NULL DEFAULT NULL COMMENT 'Date of entry creation. Hour and minute set to zero';
ALTER TABLE BASE_00i_TABLE CHANGE `fulfillment_date` `fulfillment_date` TIMESTAMP NULL DEFAULT NULL  COMMENT 'Fulfillment date from invoice';
ALTER TABLE BASE_00i_TABLE CHANGE `due_date` `due_date` TIMESTAMP NULL DEFAULT NULL  COMMENT '(Payment) Due date from invoice';
...
ALTER TABLE BASE_00i_TABLE CHANGE `personal_name` `personal_name` VARCHAR(255) COMMENT 'Personal name of user';
ALTER TABLE BASE_00i_TABLE CHANGE `personal_zip_code` `personal_zip_code` VARCHAR(20) COMMENT 'Zip code of place where user lives';
ALTER TABLE BASE_00i_TABLE CHANGE `personal_country` `personal_country` VARCHAR(50) COMMENT 'Country where user lives';
ALTER TABLE BASE_00i_TABLE CHANGE `personal_city` `personal_city` VARCHAR(50) COMMENT 'City where user lives';
ALTER TABLE BASE_00i_TABLE CHANGE `personal_address` `personal_address` VARCHAR(255) COMMENT 'Personal address';
ALTER TABLE BASE_00i_TABLE CHANGE `personal_province` `personal_province` VARCHAR(255) COMMENT 'Personal address';
ALTER TABLE BASE_00i_TABLE CHANGE `personal_city_size` `personal_city_size` VARCHAR(255) COMMENT 'Personal address';
...
ALTER TABLE BASE_00i_TABLE CHANGE `currency` `currency` char(3) COMMENT 'Currency of the order (EUR, HUF, RON)';
...
ALTER TABLE BASE_00i_TABLE CHANGE `is_canceled` `is_canceled` char(10) COMMENT 'Yes if order/item is canceled. Melyikre kell szurni? Értékek: Yes, No, Élő, Storno';
ALTER TABLE BASE_00i_TABLE CHANGE `buyer_email` `buyer_email` VARCHAR(100) COMMENT 'Megtisztitott email cim';
...
ALTER TABLE BASE_00i_TABLE CHANGE `is_color` `is_color` tinyint(1) COMMENT 'Színes-e a lencse?';
ALTER TABLE BASE_00i_TABLE CHANGE `wear_days` `wear_days` smallint(3) COMMENT 'Mennyi ideig használható az egész doboz?';
...
ALTER TABLE BASE_00i_TABLE CHANGE `quantity_in_a_pack` `quantity_in_a_pack` smallint(1) COMMENT 'How many item is in a pack., From Adams items table';
ALTER TABLE BASE_00i_TABLE CHANGE `estimated_supplier_lead_time` `estimated_supplier_lead_time` smallint(1) COMMENT 'Estimated time of delivery, From Adams items table';
ALTER TABLE BASE_00i_TABLE CHANGE `qty_per_storage_unit` `qty_per_storage_unit` smallint(1) COMMENT 'How many boxes fits a storage unit, From Adams item_groups table';
ALTER TABLE BASE_00i_TABLE CHANGE `box_width` `box_width` smallint(1) COMMENT 'Box width, From Adams item_groups table';
ALTER TABLE BASE_00i_TABLE CHANGE `box_height` `box_height` smallint(1) COMMENT 'Box height, From Adams item_groups table';
ALTER TABLE BASE_00i_TABLE CHANGE `box_depth` `box_depth` smallint(1) COMMENT 'Box depth, From Adams item_groups table';
...
ALTER TABLE BASE_00i_TABLE CHANGE `package_unit` `package_unit` char(10) COMMENT 'Kiszerelés mértékegysége: db vagy ml?';

ALTER TABLE BASE_00i_TABLE CHANGE `product_introduction_dt` `product_introduction_dt` TIMESTAMP NULL DEFAULT NULL  COMMENT 'A termék bevezetésének a dátuma';
...
ALTER TABLE BASE_00i_TABLE CHANGE `processed` `last_modified_date` TIMESTAMP NULL DEFAULT NULL  COMMENT 'Last date something happened with the item (or anything with same erp_id)';
...
/*az 'id' mező értékét megnöveljük a BASE_03_TABLE_ben található id értékével, hgy elkerüljük, hogy egy napi új tétel ugyanazon az id-n szerpeljen, mint egy régi tétel */
UPDATE BASE_00i_TABLE AS m
SET
