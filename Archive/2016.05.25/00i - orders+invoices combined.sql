...
SELECT 	DISTINCT 
		...
		r.box_height,
		r.box_depth,
		r.item_net_value_in_currency AS revenues_wdisc_in_local_currency,
		r.item_net_value_in_currency*r.exchange_rate_of_currency AS revenues_wdisc_in_base_currency,
