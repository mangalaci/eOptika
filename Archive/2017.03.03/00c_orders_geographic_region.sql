...
ALTER TABLE ORDERS_00c2 ADD INDEX `shipping_name` (`shipping_name`) USING BTREE;
...
CASE
	WHEN shipping_name_flg = 'real' THEN shipping_address
	WHEN billing_name_flg = 'real' THEN billing_address
END AS real_address,

CASE 
	WHEN shipping_name_flg = 'billing' THEN shipping_address
	WHEN billing_name_flg = 'billing' THEN billing_address 
END AS business_address,

CASE 
	WHEN shipping_name_flg = 'pickup' THEN shipping_address
	WHEN billing_name_flg = 'pickup' THEN billing_address 
END AS pickup_address,

CASE
	WHEN shipping_name_flg = 'real' THEN shipping_zip_code
	WHEN billing_name_flg = 'real' THEN billing_zip_code
END AS real_zip_code,

CASE 
	WHEN shipping_name_flg = 'billing' THEN shipping_zip_code
	WHEN billing_name_flg = 'billing' THEN billing_zip_code 
END AS business_zip_code,

CASE 
	WHEN shipping_name_flg = 'pickup' THEN shipping_zip_code
	WHEN billing_name_flg = 'pickup' THEN billing_zip_code 
END AS pickup_zip_code,

CASE
	WHEN shipping_name_flg = 'real' THEN shipping_city
	WHEN billing_name_flg = 'real' THEN billing_city
END AS real_city,

CASE 
	WHEN shipping_name_flg = 'billing' THEN shipping_city
	WHEN billing_name_flg = 'billing' THEN billing_city 
END AS business_city,

CASE 
	WHEN shipping_name_flg = 'pickup' THEN shipping_city
	WHEN billing_name_flg = 'pickup' THEN billing_city 
END AS pickup_city
...
ALTER TABLE ORDERS_00c3 ADD business_name VARCHAR(255) NOT NULL;
ALTER TABLE ORDERS_00c3 ADD business_address VARCHAR(255) NOT NULL;
ALTER TABLE ORDERS_00c3 ADD business_zip_code VARCHAR(255) NOT NULL;
ALTER TABLE ORDERS_00c3 ADD business_city_trim VARCHAR(255) NOT NULL;
