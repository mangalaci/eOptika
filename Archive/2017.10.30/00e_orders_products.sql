...
SELECT DISTINCT 
	...
	CASE
			...
			WHEN i.name_hu LIKE '%vista%' THEN 'Glasses'
			WHEN i.name_hu LIKE '%sole%' THEN 'Sunglasses'
			WHEN i.name_hu LIKE '%ReNu%' THEN 'ReNu'
			WHEN i.name_hu LIKE '%Smile%' THEN 'Smile'
			WHEN i.name_hu LIKE '%Polaroid%' THEN 'Polaroid'
			WHEN i.name_hu LIKE '%Tommy Hilfiger%' THEN 'Tommy Hilfiger'
			WHEN i.name_hu LIKE '%Carrera%' THEN 'Carrera'
			WHEN i.name_hu LIKE '%Maxxee%' THEN 'Maxxee'
			WHEN i.name_hu LIKE '%Biotrue%' THEN 'Biotrue'
			WHEN i.name_hu LIKE '%Ray-Ban%' THEN 'Ray-Ban'
			WHEN i.name_hu LIKE '%Hoyalux%' THEN 'Hoyalux'
			WHEN i.name_hu LIKE '%Nulux%' THEN 'Nulux'
			WHEN i.name_hu LIKE '%Hilux%' THEN 'Hilux'
			WHEN i.name_hu LIKE '%SV RX SPH%' THEN 'SV RX SPH'
			WHEN i.name_hu LIKE '%HoyatintUV%' THEN 'HoyatintUV'
			WHEN i.name_hu LIKE '%Chopard%' THEN 'Chopard'
    ...
    CASE 	WHEN i.name_hu LIKE '%Acuvue%' THEN 'Acuvue'
	   ...
	   WHEN i.name_hu LIKE '%Szemüvegtok%' THEN 'Spectacle-case'
		...
		WHEN i.name_hu LIKE '%Chopard%' THEN 'Chopard'
		WHEN i.name_hu LIKE '%OPTI-FREE%' THEN 'OPTI-FREE'
		WHEN i.name_hu LIKE '%Boss Orange%' THEN 'Boss Orange'
		WHEN i.name_hu LIKE '%Spy+%' THEN 'Spy+'
		WHEN i.name_hu LIKE '%Chopard%' THEN 'Chopard'
		WHEN i.name_hu LIKE '%Vogue%' THEN 'Vogue'
		WHEN i.name_hu LIKE '%Diesel%' THEN 'Diesel'
		WHEN i.name_hu LIKE '%Marc by Marc Jacobs%' THEN 'Marc by Marc Jacobs'
		WHEN i.name_hu LIKE '%MaxMara%' THEN 'MaxMara'
		WHEN i.name_hu LIKE '%Police%' THEN 'Police'
		WHEN i.name_hu LIKE '%Oxydo%' THEN 'Oxydo'
		WHEN i.name_hu LIKE '%Smith Optics%' THEN 'Smith Optics'
		WHEN i.name_hu LIKE '%Max&Co.%' THEN 'Max&Co.'
		WHEN i.name_hu LIKE '%Yves Saint Laurent%' THEN 'Yves Saint Laurent'
		WHEN i.name_hu LIKE '%Safilo%' THEN 'Safilo'
		WHEN i.name_hu LIKE '%Pierre Cardin%' THEN 'Pierre Cardin'
		WHEN i.name_hu LIKE '%Arnette%' THEN 'Arnette'
		WHEN i.name_hu LIKE '%Armani%' THEN 'Armani'
		WHEN i.name_hu LIKE '%Burberry%' THEN 'Burberry'
		WHEN i.name_hu LIKE '%United Colors of Benetton%' THEN 'United Colors of Benetton'
		WHEN i.name_hu LIKE '%Hugo Boss%' THEN 'Hugo Boss'
		WHEN i.name_hu LIKE '%Bvlgari%' THEN 'Bvlgari'
		WHEN i.name_hu LIKE '%Dolce & Gabbana%' THEN 'Dolce & Gabbana'
		WHEN i.name_hu LIKE '%Dunhill%' THEN 'Dunhill'
		WHEN i.name_hu LIKE '%Emporio Armani%' THEN 'Emporio Armani'
		WHEN i.name_hu LIKE '%Elle%' THEN 'Elle'
		WHEN i.name_hu LIKE '%Esprit%' THEN 'Esprit'
		WHEN i.name_hu LIKE '%Giorgio Armani%' THEN 'Giorgio Armani'
		WHEN i.name_hu LIKE '%Gant%' THEN 'Gant'
		WHEN i.name_hu LIKE '%H1N1%' THEN 'H1N1'
		WHEN i.name_hu LIKE '%Jaguar%' THEN 'Jaguar'
		WHEN i.name_hu LIKE '%Just Cavalli%' THEN 'Just Cavalli'
		WHEN i.name_hu LIKE '%Jimmy Choo%' THEN 'Jimmy Choo'
		WHEN i.name_hu LIKE '%Joop!%' THEN 'Joop!'
		WHEN i.name_hu LIKE '%Juicy Couture%' THEN 'Juicy Couture'
		WHEN i.name_hu LIKE '%Levi''s%' THEN 'Levis'
		WHEN i.name_hu LIKE '%Marc Jacobs%' THEN 'Marc Jacobs'
		WHEN i.name_hu LIKE '%Menrad%' THEN 'Menrad'
		WHEN i.name_hu LIKE '%Michael Kors%' THEN 'Michael Kors'
		WHEN i.name_hu LIKE '%Morgan%' THEN 'Morgan'
		WHEN i.name_hu LIKE '%Nici%' THEN 'Nici'
		WHEN i.name_hu LIKE '%Oakley%' THEN 'Oakley'
		WHEN i.name_hu LIKE '%Persol%' THEN 'Persol'
		WHEN i.name_hu LIKE '%Prada%' THEN 'Prada'
		WHEN i.name_hu LIKE '%Reebok%' THEN 'Reebok'
		WHEN i.name_hu LIKE '%Roberto Cavalli%' THEN 'Roberto Cavalli'
		WHEN i.name_hu LIKE '%Rim%' THEN 'Rim'
		WHEN i.name_hu LIKE '%Stepper%' THEN 'Stepper'
		WHEN i.name_hu LIKE '%Spirit%' THEN 'Spirit'
		WHEN i.name_hu LIKE '%Univo 1000%' THEN 'Univo 1000'
		WHEN i.name_hu LIKE '%Univo 2000%' THEN 'Univo 2000'
		WHEN i.name_hu LIKE '%Vulkan%' THEN 'Vulkan'
		WHEN i.name_hu LIKE '%Vaude%' THEN 'Vaude'
		WHEN i.name_hu LIKE '%Versace%' THEN 'Versace'
		WHEN i.name_hu LIKE '%Givenchy%' THEN 'Givenchy'
		WHEN i.name_hu LIKE '%Jean Paul Gaultier%' THEN 'Jean Paul Gaultier'
		WHEN i.name_hu LIKE '%Sting%' THEN 'Sting'
       ELSE j.general_name
	...
	j.sku_eoptika_hu AS CT2_sku,
					...
					CASE 	WHEN group_eng_corrected = 'Contact lenses' AND j.is_spheric = 1 THEN 'Spheric'
							...
							WHEN group_eng_corrected = 'Contact lenses' THEN 'Other'
...
ALTER TABLE ORDERS_00e ADD `lens_material` VARCHAR(64) DEFAULT NULL;
