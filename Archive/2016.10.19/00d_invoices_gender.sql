...
ALTER TABLE INVOICES_00d3 ADD INDEX `shipping_name_clean` (`shipping_name_clean`) USING BTREE;
...
ALTER TABLE INVOICES_00d4 ADD INDEX `shipping_name_clean` (`shipping_name_clean`) USING BTREE;
...
ALTER TABLE INVOICES_00d5 ADD INDEX `shipping_name_clean` (`shipping_name_clean`) USING BTREE;
