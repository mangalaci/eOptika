...
ALTER TABLE IN_iranyitoszamok ADD INDEX (`Telepules`) USING BTREE;
ALTER TABLE IN_postcodes_uk ADD INDEX (`town`) USING BTREE;
ALTER TABLE IN_postcodes_it ADD INDEX (`town`) USING BTREE;
