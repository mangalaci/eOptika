...
ALTER TABLE ORDERS_00c5 ADD INDEX `real_city_trim` (`real_city_trim`) USING BTREE;
ALTER TABLE ORDERS_00c5 ADD INDEX `pickup_city_trim` (`pickup_city_trim`) USING BTREE;
ALTER TABLE ORDERS_00c5 ADD INDEX `business_city_trim` (`business_city_trim`) USING BTREE;
...
CREATE TABLE IF NOT EXISTS ORDERS_00c8 LIKE ORDERS_00c7;
ALTER TABLE ORDERS_00c8 ADD `business_province` VARCHAR(255) NOT NULL;
ALTER TABLE ORDERS_00c8 ADD `business_city_size` INT(8) NOT NULL;
ALTER TABLE ORDERS_00c8 ADD `business_city` VARCHAR(255) NOT NULL;

INSERT INTO ORDERS_00c8
SELECT b.*, e.megye AS business_province, e.meret AS business_city_size, telepules_clean AS business_city
FROM ORDERS_00c7 AS b 
LEFT JOIN IN_telepules_megye2 AS e
ON e.telepules_clean = b.business_city_trim
;

UPDATE ORDERS_00c8 AS m
        INNER JOIN
