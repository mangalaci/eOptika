...
AND	item_SKU NOT IN ('GHW', 'GLS_COD', 'MCO', 'MCONS', 'MDISPLAY', 'GROWWW', 'GLS', 'GPS', 'PP', 'PPP', 'SPRINTER', 'Sprinter', 'TOF', 'WEIGHT_CORRECTION', 'szallitas', 'Személyes átvétel', 'FP', 'FPE')
/*removing test user*/
