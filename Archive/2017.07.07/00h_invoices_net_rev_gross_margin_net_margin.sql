...
SELECT t.*,
    t.gross_margin_wodisc_in_base_currency - t.shipping_cost_in_base_currency - t.packaging_cost_in_base_currency - t.payment_cost_in_base_currency AS net_margin_wodisc_in_base_currency,
	
    t.gross_margin_wdisc_in_base_currency - t.shipping_cost_in_base_currency - t.packaging_cost_in_base_currency - t.payment_cost_in_base_currency AS net_margin_wdisc_in_base_currency,
	
   (t.gross_margin_wodisc_in_base_currency - t.shipping_cost_in_base_currency - t.packaging_cost_in_base_currency - t.payment_cost_in_base_currency)/(t.item_net_value_in_currency*t.exchange_rate_of_currency) AS `net_margin_wodisc_%`,
	
    (t.gross_margin_wdisc_in_base_currency - t.shipping_cost_in_base_currency - t.packaging_cost_in_base_currency - t.payment_cost_in_base_currency)/(t.item_net_value_in_currency*t.exchange_rate_of_currency) AS `net_margin_wdisc_%`
