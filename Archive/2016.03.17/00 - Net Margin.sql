...
SELECT
	...
	SUM(item_net_purchase_price_in_base_currency * item_quantity) as order_cogs,
	SUM(item_gross_value_in_currency*exchange_rate_of_currency) as gross_order_value,
	SUM(item_net_value_in_currency*exchange_rate_of_currency) as net_order_value
...
DROP TABLE shipping_costs_on_orders;
  	...
  	CASE
  		WHEN n.shipping_method != 'GPSe'
  			...
  			ELSE
  				...
  				END
  	END
	/* in case the order lighter than half a kilo we can use the tariff of category “G” otherwise we have to use “E”.*/
