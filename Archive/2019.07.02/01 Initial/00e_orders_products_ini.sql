...
SELECT DISTINCT
	...
	i.net_weight_in_kg,
					...
					CASE WHEN (j.parent_id IN (4,5,6,7,77,101,124) OR j.general_name LIKE '%Szemüveglencsék%') AND LOCATE('AX: ',i.name_hu) > 0 THEN REPLACE(SUBSTR(i.name_hu, LOCATE('AX: ',i.name_hu)+4, 4), '°', '')
						 ELSE NULL
					END AS lens_ax,
