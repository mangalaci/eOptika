...
UPDATE BASE_03_TABLE SET personal_name = CAP_FIRST(personal_name) WHERE new_entry = 1;
UPDATE BASE_03_TABLE SET pickup_name = CAP_FIRST(pickup_name) WHERE new_entry = 1;
UPDATE BASE_03_TABLE SET business_name = CAP_FIRST(business_name) WHERE new_entry = 1;
