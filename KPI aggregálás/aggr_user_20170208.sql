...
ALTER TABLE `AGGR_USER_UNSANITIZED` ADD `id` INT UNSIGNED NOT NULL AUTO_INCREMENT FIRST, ADD PRIMARY KEY (`id`);
ALTER TABLE AGGR_USER_UNSANITIZED ADD INDEX `user_id` (`user_id`) USING BTREE;
...
UPDATE AGGR_USER_SANITIZED SET buyer_email = NULL WHERE buyer_email IS NOT NULL;
