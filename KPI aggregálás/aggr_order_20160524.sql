...
SELECT 	origin,
		...
		SUM(gross_margin_wdisc_in_base_currency)/SUM(revenues_wdisc_in_base_currency) AS `gross_margin_wdisc_%`,
		newsletter,
		cohort_id,
		invoice_yearmonth,
		invoice_year,
		...
		SUM(net_margin_wdisc_in_base_currency)/SUM(revenues_wdisc_in_base_currency) AS `net_margin_wdisc_%`,
