...
SELECT 	user_id,
		...
		ROUND(SUM(gross_margin_wodisc_in_base_currency)/SUM(item_revenue_in_base_currency),0) AS `gross_margin_wodisc_%`,
		ROUND(SUM(gross_margin_wdisc_in_base_currency)/SUM(revenues_wdisc_in_base_currency),0) AS `gross_margin_wdisc_%`,		
		newsletter,
		cohort_id,
		cohort_month_since,
