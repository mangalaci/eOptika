...
DELETE FROM INVOICES_00_inc 
USING INVOICES_00_inc, bbb
WHERE bbb.erp_id = INVOICES_00_inc.erp_id 
AND bbb.item_sku = INVOICES_00_inc.item_sku
AND INVOICES_00_inc.new_entry = 1 /*csak az uj sorokat update-eljük*/
;
...
DELETE FROM INVOICES_00_inc 
USING INVOICES_00_inc, INVOICES_rabat 
WHERE INVOICES_rabat.sql_id = INVOICES_00_inc.sql_id
;
