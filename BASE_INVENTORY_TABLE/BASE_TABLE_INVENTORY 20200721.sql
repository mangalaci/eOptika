...
DROP TABLE IF EXISTS sku_service_level;
CREATE TABLE IF NOT EXISTS sku_service_level
SELECT 
	i.item_SKU,
	i.related_division,
	i.related_warehouse,
...
ALTER TABLE sku_service_level ADD PRIMARY KEY (`item_sku`) USING BTREE;
