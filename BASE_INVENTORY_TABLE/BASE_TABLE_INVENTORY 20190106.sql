...
SELECT b.CT1_SKU, AVG(b.item_net_purchase_price_in_base_currency) AS  avg_last_purchase_price
...
SELECT p.*, s.avg_last_purchase_price
...
WHERE CONCAT(b.CT1_sku, b.related_warehouse) NOT IN
(
